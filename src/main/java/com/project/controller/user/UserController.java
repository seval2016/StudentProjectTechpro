...
import com.project.payload.user.UserService;
...
public class UserController {
    ...
    @PreAuthorize("hasAnyAuthority('ADMIN')")
    public ResponseMessage<BaseUserResponse> updateAdminDeanViceDeanForAdmin( @RequestBody @Valid UserRequest userRequest, @PathVariable Long userId){
